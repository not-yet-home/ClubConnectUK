...
/**
 * Multi-select filter with popover for table columns.
 * Can work with TanStack Table column or standalone with controlled values.
 */
...
export type { FilterOption, DataTableFilterProps }
