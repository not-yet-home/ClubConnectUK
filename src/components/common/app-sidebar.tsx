  ...
  const navItems = [
    {
      ...
      url: '/dashboard',
      icon: () => (
        <HugeiconsIcon icon={DashboardSquare01Icon} className={ICON_SIZES.md} />
      ),
      isActive: false,
    },
    {
      ...
      url: '/covers',
      icon: () => (
        <HugeiconsIcon icon={Calendar04Icon} className={ICON_SIZES.md} />
      ),
      isActive: false,
    },
    {
      ...
      icon: () => (
        <HugeiconsIcon icon={TeachingIcon} className={ICON_SIZES.md} />
      ),
      isActive: false,
    },
    {
      ...
      url: '/clubs/club-list',
      icon: () => (
        <HugeiconsIcon icon={UserGroupIcon} className={ICON_SIZES.md} />
      ),
      isActive: false,
    },
    {
