...
const withDragAndDrop: any =
  (withDragAndDropAcccent as any).default || withDragAndDropAcccent
...
export function CalendarView({
  ...
  const CustomDateCellWrapper = (props: DateCellWrapperProps) => {
    ...
    return <div className="h-full flex flex-col bg-white">{children}</div>
  }
  ...
  return (
    <div className="h-full bg-white overflow-hidden relative">
      <DragAndDropCalendar
        ...
        components={{
          event:
            view === Views.MONTH ? MonthEventComponent : WeekEventComponent,
